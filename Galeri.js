...
const Galeri = ({navigation}) => {
    return (
        ...
        <View style={{marginRight:10,marginLeft: 10,marginTop: 10,borderRadius:100,overflow:'hidden',borderWidth:1,paddingTop:12,paddingBottom:12,backgroundColor:'#A52A2A',borderColor:'#A52A2A'}}>
